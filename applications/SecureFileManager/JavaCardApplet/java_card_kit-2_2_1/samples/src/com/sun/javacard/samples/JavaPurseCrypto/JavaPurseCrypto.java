...
/*
 * @(#)JavaPurseCrypto.java	1.4 03/06/06
 */
 ...
 * <p>See <em>Java Card(TM) Reference Implementation User's Guide</em> 
 * for details.
 *
 * @author Vadim Temkin, Modified to include cryptographic signatures by M. Saltz
 */
public class JavaPurseCrypto extends Applet  {
  /*
   *
   * Constants
   *
  ...
  final static short    MAX_MAC_DATA = (short) 0x001E; //maximimum length of data used in MAC
  ...
  final static short 	SW_SUCCESS = (short)0x9000;//SW bytes for success, used in MAC.
  ...
  /*
   * The DES key used for DES MAC calculations. The keyData should be gotten via an update
   * method call in a real application.
   */
   byte[] keyData   = {(byte)0x11, (byte)0x33, (byte)0x22, (byte)0x05, (byte)0x44,
			 (byte)0x77, (byte)0x06, (byte)0x08};
   ...
   */
  protected JavaPurseCrypto(byte[] bArray, short bOffset, byte bLength)
  {        
