...
//		int sdCount = 0;
		...
		Drawable encryptedFileIcon = context.getResources().getDrawable(R.drawable.icon_encrypted);
        	  ...
        	  if (currentFile.isHidden()) {
				...
				if (currentFile.isDirectory()) { 
					...
					if (fileName.endsWith(".enc")) {
						...
						currentIcon = encryptedFileIcon;
//						actualFileNames.put(fileName, fileName+".enc");
					}
