...
#define PCSCLITE_CONFIG_DIR		"/data/data/com.gieseckedevrient.android.pcscdroid/files/etc"
#define PCSCLITE_IPC_DIR		"/data/data/com.gieseckedevrient.android.pcscdroid/files/ipc"
