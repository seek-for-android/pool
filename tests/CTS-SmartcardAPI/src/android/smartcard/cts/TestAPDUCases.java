...
public class TestAPDUCases extends SmartcardTestCase {
	 ...
	 * @throws IOException 
	 */
	public void testAPDUCase1() throws CardException {
		if (LOG_VERBOSE) Log.v(TAG, "testAPDUCase1()");

		ICardChannel channel = mSmartcardClient.openBasicChannel(mReader, AID_APDU_TESTER);
	 ...
	 * @throws IOException
	 */
	public void testAPDUCase2() throws CardException {
	 ...
	 * @throws IOException
	 */
	public void testAPDUCase3() throws CardException {
	 ...
	 * @throws IOException
	 */
	public void testAPDUCase4() throws CardException {
