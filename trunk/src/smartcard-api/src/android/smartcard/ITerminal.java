...
public interface ITerminal {
	 ...
	 * With this command the default application will be selected on the card. (e.g. CardManager) 
	 * @throw NoSuchElementException if the default applet couldn't be found or selected 
	 */
	public void  select();
	 ...
	 * @throw NoSuchElementException if the corresponding applet couldn't be found 
	 */
	...
	/**
	 * Returns <code>true</code> if terminal is connected <code>false</code> otherwise.
