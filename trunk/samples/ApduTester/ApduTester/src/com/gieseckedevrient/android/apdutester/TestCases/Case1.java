...
public class Case1 extends TestCase {
	public final String description = "Legacy test case 1";

	@Override
	public boolean run(TestPerformer pt, Channel channel) throws Exception {
		ArrayList<Byte> cmdApduA = new ArrayList<Byte>();
		cmdApduA.add((byte) 0x00); // CLA
		cmdApduA.add((byte) 0x01); // INS
		cmdApduA.add((byte) 0x00); // P1
		cmdApduA.add((byte) 0x00); // P2
		time.add(pt.send(channel, cmdApduA, 0, this));
