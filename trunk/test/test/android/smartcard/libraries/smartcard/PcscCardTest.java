...
/**
 * JUnit tests for the class 'android.smartcard.libraries.smartcard.PcscCard'.
 */
public class PcscCardTest extends TestCase {
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#beginExclusive()}.
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#disconnect(boolean)}.
	 * @throws CardException 
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#endExclusive()}.
	 * @throws CardException 
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#getATR()}.
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#getBasicChannel()}.
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#getProtocol()}.
	 */
	public final void testGetProtocol() {
		assertEquals("T=0", card.getProtocol());
	}

	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#openLogicalChannel()}.
	 * @throws CardException 
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCard#transmitControlCommand(int, byte[])}.
	 */
