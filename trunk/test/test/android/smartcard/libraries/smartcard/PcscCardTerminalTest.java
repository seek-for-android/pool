...
/**
 * JUnit tests for the class 'android.smartcard.libraries.smartcard.PcscCardTerminal'.
 */
public class PcscCardTerminalTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		terminal = TerminalFactory.getInstance(TerminalFactory.PCSC_TYPE, null).terminals().list().get(0);
	}

	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminal#connect(java.lang.String)}.
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminal#getName()}.
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminal#isCardPresent()}.
	 * @throws CardException 
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminal#waitForCardAbsent(long)}.
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminal#waitForCardPresent(long)}.
	 * @throws CardException 
	 */
