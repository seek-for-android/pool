 ...
 */
public class PcscCardTerminalsTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		terminals = TerminalFactory.getInstance(TerminalFactory.PCSC_TYPE, null).terminals();
	}
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminals#list(android.smartcard.CardTerminals.State)}.
	 * @throws CardException 
	 */
	...
	/**
	 * Test method for {@link android.smartcard.libraries.smartcard.PcscCardTerminals#waitForChange(long)}.
	 * @throws CardException 
	 */
